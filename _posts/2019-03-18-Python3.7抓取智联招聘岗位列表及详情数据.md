...
def parse_page(keyword, url, city_code):
    try:
        ...
        for r in result:
            ...
            insert_sql = """insert into	jobs(keyword,company,size,type,company_url,eduLevel,emplType,jobName,jobTag,jobType,position,positionURL,rate,salary,workingExp,city_code) 
                                values ('{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}','{}');
                        """.format(keyword,company,size,type,company_url,eduLevel,emplType,jobName,jobTag,jobType,position,positionURL,rate,salary,workingExp,city_code)
            try:
